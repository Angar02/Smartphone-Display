// Portfolio data for carousel
        ...
        $.getJSON('ajax/landing-page.php', function (data) {
            data.forEach(e => {
                smartphones.push({
                    id: e.id,
                    title: e.name,
        ...
        function initCarousel() {
            ...
            smartphones.forEach((data, index) => {
        ...
        function nextSlide() {
            currentIndex = (currentIndex + 1) % smartphones.length;
            updateCarousel();
        }

        function prevSlide() {
            currentIndex = (currentIndex - 1 + smartphones.length) % smartphones.length;
            updateCarousel();
        }
